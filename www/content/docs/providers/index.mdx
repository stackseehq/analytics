...
<Cards>
  <Card title="PostHog" href="/docs/providers/posthog" icon={<ChartBarIcon />}>
    Open-source product analytics with feature flags and session replay
  </Card>
  <Card title="Bento" href="/docs/providers/bento" icon={<MailIcon />}>
    Email marketing and automation platform with event tracking
  </Card>
  <Card title="Pirsch" href="/docs/providers/pirsch" icon={<ShieldCheckIcon />}>
    Privacy-focused, cookie-free web analytics
  </Card>
  <Card title="Proxy Provider" href="/docs/providers/proxy" icon={<ServerIcon />}>
