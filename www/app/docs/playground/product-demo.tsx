...
import { Heart, ShoppingCart, Star, Plus, Minus, Share2, Eye } from 'lucide-react';
...
const PRODUCT = {
  ...
  rating: 4.8,
  reviews: 1247,
  description: 'Experience studio-quality sound with our flagship wireless headphones. Advanced noise cancellation, 40-hour battery life, and premium comfort.',
  features: [
