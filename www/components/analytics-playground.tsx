      ...
      {showHeader && (
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Interact with the product page and watch events flow to multiple analytics providers in real-time
          </p>
        </div>
      )}

      {/* Main Grid */}
      <div className={compact ? "grid grid-cols-1 md:grid-cols-2 gap-4" : "grid grid-cols-1 lg:grid-cols-3 gap-6"}>
